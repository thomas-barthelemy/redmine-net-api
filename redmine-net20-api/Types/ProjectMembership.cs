...
namespace Redmine.Net.Api.Types
{
    ...
    ///     PUT - Updates the membership of given :id. Only the roles can be updated, the project and the user of a membership
    ///     are read-only.
    ///     DELETE - Deletes a memberships. Memberships inherited from a group membership can not be deleted. You must delete
    ///     the group membership.
    /// </summary>
    [XmlRoot("membership")]
    public class ProjectMembership : Identifiable<ProjectMembership>,
        IEquatable<ProjectMembership>,
        IXmlSerializable
    {
        /// <summary>
        ...
        public bool Equals(ProjectMembership other)
        {
            ...
            return (Id == other.Id && Project == other.Project && Roles == other.Roles &&
                    User == other.User && Group == other.Group);
        }
            ...
            while (!reader.EOF)
            {
                ...
                switch (reader.Name)
                {
                    ...
                    case "user":
                        ...
                        break;
                    case "group":
                        Group = new IdentifiableName(reader);
                        break;
                    case "roles":
