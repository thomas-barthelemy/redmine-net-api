...
namespace Redmine.Net.Api.Types
{
    ...
    /// </summary>
    [XmlRoot("time_entry")]
    public class TimeEntry : Identifiable<TimeEntry>,
        ICloneable,
        IEquatable<TimeEntry>,
        IXmlSerializable
    {
        /// <summary>
        ...
        /// <summary>
        ///     Gets or sets the activity id of the time activity. This parameter is required unless a default activity is defined
        ///     in Redmine..
        /// </summary>
        ...
        public bool Equals(TimeEntry other)
        {
            ...
            return (Id == other.Id && Issue == other.Issue && Project == other.Project &&
                    SpentOn == other.SpentOn && Hours == other.Hours
                    && Activity == other.Activity && Comments == other.Comments &&
                    User == other.User && CreatedOn == other.CreatedOn &&
                    UpdatedOn == other.UpdatedOn && CustomFields == other.CustomFields);
        }
            ...
            while (!reader.EOF)
            {
                ...
                switch (reader.Name)
                {
                    case "id":
                        ...
                        break;
                    case "issue_id":
                        Issue = new IdentifiableName(reader);
                        break;
                    case "issue":
                        Issue = new IdentifiableName(reader);
                        break;
                    ...
                    case "project":
                        ...
                        break;
                    case "spent_on":
                        SpentOn = reader.ReadElementContentAsNullableDateTime();
                        break;
                    case "user":
                        User = new IdentifiableName(reader);
                        break;
                    case "hours":
                        Hours = reader.ReadElementContentAsDecimal();
                        break;
                    case "activity_id":
                        Activity = new IdentifiableName(reader);
                        break;
                    case "activity":
                        Activity = new IdentifiableName(reader);
                        break;
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteElementString(
                "spent_on",
                SpentOn.Value.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture));
            writer.WriteElementString(
                "hours",
