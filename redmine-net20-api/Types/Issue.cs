...
namespace Redmine.Net.Api.Types
{
    ...
    ///     Possible values: children, attachments, relations, changesets and journals. To fetch multiple associations use
    ///     comma (e.g ?include=relations,journals).
    ///     See Issue journals for more information.
    /// </summary>
    [XmlRoot("issue")]
    public class Issue : Identifiable<Issue>,
        IXmlSerializable,
        IEquatable<Issue>,
        ICloneable
    {
        ...
        public bool Equals(Issue other)
        {
            ...
            return (Id == other.Id && Project == other.Project && Tracker == other.Tracker &&
                    ...
                    && DueDate == other.DueDate && DoneRatio == other.DoneRatio &&
                    EstimatedHours == other.EstimatedHours &&
                    CustomFields == other.CustomFields
                    && CreatedOn == other.CreatedOn && UpdatedOn == other.UpdatedOn &&
                    AssignedTo == other.AssignedTo && FixedVersion == other.FixedVersion
                    && Notes == other.Notes && Watchers == other.Watchers &&
                    ClosedOn == other.ClosedOn && SpentHours == other.SpentHours
                );
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteElementString(
                ...
                ParentIssue == null
                    ? null
                    : ParentIssue.Id.ToString(CultureInfo.InvariantCulture));
